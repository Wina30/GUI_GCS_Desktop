...
namespace WindowsFormsApp7
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(WindowsFormsApp7.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(WindowsFormsApp7.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(WindowsFormsApp7.control.Resource1.TurnCoordinatorMarks);
