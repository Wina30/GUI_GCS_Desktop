...
namespace WindowsFormsApp7
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(WindowsFormsApp7.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(WindowsFormsApp7.control.Resource1.HeadingIndicator_Aircraft);        
