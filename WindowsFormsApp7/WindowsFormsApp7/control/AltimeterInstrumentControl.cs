...
namespace WindowsFormsApp7
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(WindowsFormsApp7.control.Resource1.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(WindowsFormsApp7.control.Resource1.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(WindowsFormsApp7.control.Resource1.Bandeau_Dérouleur);
