...
namespace WindowsFormsApp7
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WindowsFormsApp7.control.Resource1.AirSpeedNeedle);
