...
namespace WindowsFormsApp7
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WindowsFormsApp7.control.Resource1.VerticalSpeedNeedle);
