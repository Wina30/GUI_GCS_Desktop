...
namespace WindowsFormsApp7
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp7.control.Resource1.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(WindowsFormsApp7.control.Resource1.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(WindowsFormsApp7.control.Resource1.Maquette_Avion);
